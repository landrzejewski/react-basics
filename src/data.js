export const CORE_CONCEPTS = [
  {
    title: 'Hardware',
    description:
      'The physical components of a computer system including processors, memory, storage, and peripherals.',
  },
  {
    title: 'Software',
    description:
      'Programs and applications that run on computer hardware, including operating systems, utilities, and applications.',
  },
  {
    title: 'Networking',
    description:
      'Technologies that connect computers together, enabling communication and resource sharing between systems.',
  },
  {
    title: 'Security',
    description:
      'Measures and practices designed to protect computer systems, networks, and data from unauthorized access or attacks.',
  },
];
